...
You're almost there! The files just need to be created in your Downloads folder.

## Step 1: Check what files you have

In Terminal, run:
```bash
ls ~/Downloads/NBA_Analytics-main/
```

This will show you what files are currently there.
...
### Create app.py
```bash
cat > ~/Downloads/NBA_Analytics-main/app.py << 'EOF'
...
Press Enter after pasting that command.

Then continue with the remaining steps in Terminal...
